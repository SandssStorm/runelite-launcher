...
cp native/build-x86/src/Release/Velheim.exe build/win-x86/
cp build/libs/Velheim.jar build/win-x86/
...
echo Velheim.exe 32bit sha256sum
sha256sum build/win-x86/Velheim.exe

dumpbin //HEADERS build/win-x86/Velheim.exe
