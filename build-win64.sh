...
cp native/build-x64/src/Release/Velheim.exe build/win-x64/
cp build/libs/Velheim.jar build/win-x64/
...
echo Velheim.exe 64bit sha256sum
sha256sum build/win-x64/Velheim.exe

dumpbin //HEADERS build/win-x64/Velheim.exe
