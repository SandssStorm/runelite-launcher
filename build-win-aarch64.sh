...
cp native/build-aarch64/src/Release/Velheim.exe build/win-aarch64/
cp build/libs/Velheim.jar build/win-aarch64/
...
echo Velheim.exe aarch64 sha256sum
sha256sum build/win-aarch64/Velheim.exe

dumpbin //HEADERS build/win-aarch64/Velheim.exe
